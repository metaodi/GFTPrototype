...
Als wir den Zugriff auf das Trusted Tester API (siehe Abschnitt \ref{trusted-tester-api}) bekommen haben, konnten wir den Serverteil wieder entfernen. Google hat dort die Möglichkeit hinzugefügt hat, direkt Requests ans API zu schicken, ohne einen Umweg über \gls{AJAX} \todo{stimmt hier AJAX} zu machen\footnote{Google APIs Client Library for JavaScript: \url{http://code.google.com/p/google-api-javascript-client/}}.
