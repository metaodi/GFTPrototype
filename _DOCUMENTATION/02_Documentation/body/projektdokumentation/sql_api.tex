...
Um mehrere Bedingungen in einer \inlinecode{WHERE}-Klausel zu verwenden können diese mit \inlinecode{AND} verbunden werden. Verknüpfungen mit \inlinecode{OR} sind hingegen nicht unterstützt.
