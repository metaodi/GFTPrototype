...
\section{Testing}
Die Applikationslogik dieses Use Cases befindet sich vor allem im Controller und zu kleinen Teilen im Helper. Für diese beiden Komponenten haben wir jeweils Tests erstellt, insgesamt 12\footnote{Ausführbare Tests: \url{http://gft.rdmr.ch/test/js/?filter=WorldData}}.
...
Die Anzeige der Daten basiert auf dem FusionTablesLayer des Google Maps \gls{API}, weshalb wir dort keine eigene Logik haben.
