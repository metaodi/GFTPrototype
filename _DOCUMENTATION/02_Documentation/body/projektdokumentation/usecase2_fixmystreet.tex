...
% Ziel
\subsection{Ziel}
Das Ziel dieses Use Cases war die Erstellung einer Web-App, welche genau dieses Konzept umsetzt. Die Benutzer sollen die Möglichkeit haben Defekte in ihrer Umgebung dem zuständigen Amt zu melden.
...
\item Sie öffnet die \emph{FixMyStreet} Web-App auf ihrem Handy und meldet den Standort der defekten Strassenlampe.
...
Die \emph{FixMyStreet} Web-App soll folgende Use Cases abdecken.
...
\textit{Preconditions} & Web-App ist gestartet \\ 
...
\end{enumerate} \\ 
\textit{Alternative Flows} & 2a. Markierung muss nicht zwangsläufig verschoben werden. Sie zeigt beim Starten der Web-App auf die aktuelle Position

2b. Falls die Web-App nicht auf die aktuelle Position zugreifen kann, zeigt die Markierung auf einen vorkonfigurierten Ort \\ 
...
Die Web-App basiert auf dem Sencha Touch 2 Framework\footnote{\url{http://www.sencha.com/products/touch/}}. Dieses bietet eine Basis zur Erstellung von mobilen Web-Apps mit JavaScript. Das Framework bietet die Möglichkeit eine Applikation nach dem MVC-Pattern aufzubauen.
...
Der Proxy implementiert lediglich die in unserem UseCase verwendeten CRUD-Operationen \inlinecode{Create}, \inlinecode{Read} und \inlinecode{Delete}. Ein Änderung (\inlinecode{Update}) von gemeldeten Defekten ist über die Web-App nicht vorgesehen und wurde deshalb auch nicht implementiert.
