...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.4]{images/usecase2-fixmystreet/uml/fixmystreet-usecasediagram.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{images/usecase2-fixmystreet/uml/fixmystreet-deployment_model.png}
	\caption{FixMyStreet Deploymentdiagramm}
	\label{fixmystreet-deployment_model}
\end{figure}
