...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.4]{images/usecase2-fixmystreet/fixmystreet-usecasediagram.png}
...
app/controller/Main.js & Hautp-Kontroller der Applikation (Steuert die einzelnen Ansichten) \\ 
