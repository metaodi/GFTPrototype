...
Vor der Implementation der Oberfläche wurde das GUI-Design zuerst als Paper-Prototype erstellt und von verschiedenen Personen getestet. Dieser besteht aus drei verschiedenen Hauptmasken.
...
\item Falls noch keine UserId vorhanden ist, wird diese generiert und in den LocalStorage geschrieben
