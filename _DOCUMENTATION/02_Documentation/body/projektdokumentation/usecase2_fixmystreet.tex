...
Zusätzlich konnten wir die GIS-Features, welche Google Fusion Tables anbieten nur minimal nutzen. So hinderte uns die fehlende  Geocodierung von neu eingefügten Datensätzen \todo[inline]{Referenz auf Geocoding Bug einfügen} daran Spatial-Queries zu verwenden.
