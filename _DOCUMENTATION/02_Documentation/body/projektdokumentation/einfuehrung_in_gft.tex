...
Merged Tables haben einige Einschränkungen. So lassen sie sich bislang nicht via API erstellen, sondern aussschliesslich über das Web-GUI. \inlinecode{INSERT}-Befehle sind nicht möglich und \inlinecode{UPDATE} nur auf Attributen, die nicht am Join beteiligt sind.
