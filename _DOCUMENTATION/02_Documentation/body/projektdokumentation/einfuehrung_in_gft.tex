...
\subsubsection{Persönliche Erfahrungen beim Benutzen von Stilen}
Wie wir beim Erstellen unseres ersten UseCases \emph{WorldData} feststellen mussten, sind diese 5 Stile sehr schnell aufgebraucht. Einer davon fällt meistens für den Standard-Stil weg. Dieser wird angewendet, wenn die entsprechende Zeile aus der Tabelle auf keine Bedingung der restlichen Stile passt. So bleiben lediglich noch 4 Stile übrig für alle Elemente die man speziell hervorheben möchte.

Sobald man dann auch noch verschiedene Geometrie-Typen in der Tabelle abgelegt hat (Punkt, Linie, Fläche), muss man sich gut entscheiden, für welche Elemente man wirklich einen speziellen Stil anwenden will.
