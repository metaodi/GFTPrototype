...
\begin{figure}[H]
\subfigure[Defekte Strassenlampe entdeckt]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/storyboard/fixmystreet-storyboard-1}}
\hfill
\subfigure[Defekt melden]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/storyboard/fixmystreet-storyboard-2}}
\end{figure}

\begin{figure}[H]
\subfigure[Neue Meldungen überprüfen]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/storyboard/fixmystreet-storyboard-3}}
\hfill
\subfigure[Defekt reparieren]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/storyboard/fixmystreet-storyboard-4}}
\end{figure}

\begin{figure}[H]
\subfigure[Defekt repariert]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/storyboard/fixmystreet-storyboard-5}}
\end{figure}
...
\begin{figure}[H]
\subfigure[Defekt melden - Übersicht]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/paperprototype/fixmystreet-pp-melden}}
\hfill
\subfigure[Fehleranzeige beim Absenden ohne Defekttyp-Auswahl]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/paperprototype/fixmystreet-pp-melden_fehler}}
\end{figure}

\begin{figure}[H]
\subfigure[Defekttyp-Auswahl aufgeklappt]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/paperprototype/fixmystreet-pp-melden_defektauswaehlen}}
\hfill
\subfigure[Defekttyp ausgewählt]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/paperprototype/fixmystreet-pp-melden_defektausgewaehlt}}
\end{figure}

\begin{figure}[H]
\subfigure[Defekt-Markierung auf Karte verschoben]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/paperprototype/fixmystreet-pp-melden_ortgewaehlt}}
\hfill
\subfigure[Defekt erfolgreich gemeldet]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/paperprototype/fixmystreet-pp-melden_meldungerfolgreich}}
\end{figure}
...
\begin{figure}[H]
\subfigure[Defekte verwalten - Übersicht]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/paperprototype/fixmystreet-pp-verwalten}}
\hfill
\subfigure[Detailansicht eines gemeldeten Defekts]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/paperprototype/fixmystreet-pp-verwalten_detail}}
\end{figure}
...
\begin{figure}[H]
\subfigure[Anzeigen - Übersicht]{\includegraphics[width=0.43\textwidth]{images/usecase2-fixmystreet/paperprototype/fixmystreet-pp-anzeigen}}
\end{figure}
...
Der Code-Ausschnitt \ref{st2-componentquery}\footnote{Quelle: \url{http://docs.sencha.com/touch/2-0/\#!/api/Ext.app.Controller} (Stand: 24.05.2012)} zeigt einen Teil eines Controllers. Dieser referenziert im Property \inlinecode{nav} via Component-Query die View-Komponente mit der ID \inlinecode{mainNav}.
