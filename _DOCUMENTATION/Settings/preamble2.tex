...
%\usepackage{gb4e} % linguistic examples, trees
%\usepackage{wrapfig}
...
\usepackage{hyperref}
\hypersetup{%
  pdfauthor={Stefanie Herzig},
  pdftitle={Gezwitscherte Kommunikation - Der Tweet aus textlinguistischer Sicht},
  pdfsubject={},
  pdfkeywords={},
  pdfborder=000
}
% so werden Hyperlinks nicht gefÃÂ¤rbt
...
% Plain Pagestyle fÃÂ¼r Kapitelanfangsseite
...
% Neues Kapitel Makro, damit die Variablen korrekt abgefÃÂ¼llt werden
\newcommand{\newchap}[1]{
	\chapter{#1}
...
% Befehle fÃÂ¼r AnfÃÂ¼hrungszeichen
\usepackage{xspace} % Leerschlag nach AnfÃÂ¼hrungszeichen
