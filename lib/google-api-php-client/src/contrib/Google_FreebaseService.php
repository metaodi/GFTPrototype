...
class Google_FreebaseService extends Google_Service {
  ...
  public function __construct(Google_Client $client) {
    ...
    $this-> = new Google_MqlreadServiceResource($this, $this->serviceName, 'mqlread', json_decode('{"id": "freebase.mqlread", "httpMethod": "GET", "supportsMediaDownload": true, "parameters": {"lang": {"default": "/lang/en", "type": "string", "location": "query"}, "html_escape": {"default": "true", "type": "boolean", "location": "query"}, "indent": {"default": "0", "location": "query", "type": "integer", "maximum": "10", "format": "uint32"}, "uniqueness_failure": {"default": "hard", "enum": ["hard", "soft"], "type": "string", "location": "query"}, "dateline": {"type": "string", "location": "query"}, "cursor": {"type": "string", "location": "query"}, "callback": {"type": "string", "location": "query"}, "cost": {"default": "false", "type": "boolean", "location": "query"}, "query": {"required": true, "type": "string", "location": "query"}, "as_of_time": {"type": "string", "location": "query"}}, "path": "mqlread"}', true));
    $this-> = new Google_ImageServiceResource($this, $this->serviceName, 'image', json_decode('{"id": "freebase.image", "httpMethod": "GET", "supportsMediaDownload": true, "parameters": {"maxwidth": {"type": "integer", "location": "query", "maximum": "4096", "format": "uint32"}, "maxheight": {"type": "integer", "location": "query", "maximum": "4096", "format": "uint32"}, "fallbackid": {"default": "/freebase/no_image_png", "type": "string", "location": "query"}, "pad": {"default": "false", "type": "boolean", "location": "query"}, "mode": {"default": "fit", "enum": ["fill", "fillcrop", "fillcropmid", "fit"], "type": "string", "location": "query"}, "id": {"repeated": true, "required": true, "type": "string", "location": "path"}}, "path": "image{/id*}"}', true));
  }
}
